...
void __fastcall TFo_Main::Ti_CheckTimer(TObject *Sender) {
  ...
  FomainTimerOps::HandleContinuousLoad(this);
  FomainTimerOps::HandleAutoReload(this, tgt);
  FomainTimerOps::HandleAutoSave(this, tgt);
  FomainTimerOps::HandlePluginTimeout(this);
  FomainTimerOps::ApplyDefaultView(this);
  if (FomainTimerOps::ApplyOperationRequests(this, Sender)) {
    return;
  }
  FomainTimerOps::UpdateWindowTitles(this);
  FomainTimerOps::UpdateFileListPanel(this);
